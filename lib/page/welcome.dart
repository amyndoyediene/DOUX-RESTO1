...
class CommencerPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFFFF0000), // Rouge vif
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                      'assets/doux1.jpeg'), // Assurez-vous que votre image est dans le dossier assets
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: Colors.black, // Couleur noire // Couleur d'arrière-plan rose foncé
